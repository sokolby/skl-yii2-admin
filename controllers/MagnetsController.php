...
use amnah\yii2\user\models\Magnets;
...
class MagnetsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = $this->module->model("MagnetsSearch");
    ...
    public function actionCreate()
    {
        ...
        $user = $this->module->model("Magnets");
        ...
        if(isset($post_req['Magnets']['items'])){
            $post_req = Yii::$app->request->post();
            $json_encode = json_encode($post_req['Magnets']['items'], JSON_HEX_TAG|JSON_HEX_AMP|JSON_HEX_QUOT);

            $post_req['Magnets']['items'] = $json_encode;
        }
