...
class User extends ActiveRecord implements IdentityInterface, \OAuth2\Storage\UserCredentialsInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'logged_in_ip' => Yii::t('user', 'Авторизован с IP'),
            'logged_in_at' => Yii::t('user', 'Время авторизации'),
            'created_ip' => Yii::t('user', 'Создан с IP'),
            'created_at' => Yii::t('user', 'Создан'),
            'updated_at' => Yii::t('user', 'Дата редактирования'),
            'banned_at' => Yii::t('user', 'блокировка'),
            'banned_reason' => Yii::t('user', 'Причина блокировки'),

            // virtual attributes set above
            'currentPassword' => Yii::t('user', 'Текущий пароль'),
            'newPassword' => $this->isNewRecord ? Yii::t('user', 'Password') : Yii::t('user', 'Новый пароль'),
            'newPasswordConfirm' => Yii::t('user', 'Повторите новый пароль'),
        ];
    }
