...
$this->title = Yii::t('user', 'Бонусные баллы');
...
<div class="user-index">
    ...
    <p>
        <?= Html::a(Yii::t('user', 'Начисление баллов', [
            'modelClass' => 'User',
        ]), ['addpoints'], ['class' => 'btn btn-success']) ?>

        <?= Html::a(Yii::t('user', 'Списание баллов', [
            'modelClass' => 'User',
        ]), ['removepoints'], ['class' => 'btn btn-success']) ?>
    </p>
